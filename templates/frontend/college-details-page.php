<?php
/**
 * College Details Page Template (Shortcode version)
 * Works with ?college_id parameter
 *
 * @package CK_OneForm
 */
...
if (!$college_id) {
    echo '<div class="ck-college-error">';
    echo '<p>No college selected. Please <a href="' . home_url('/colleges/') . '">browse our colleges</a>.</p>';
    echo '</div>';
    return;
}

// Get the college post
$college = get_post($college_id);

if (!$college || $college->post_type !== 'ck_college') {
    echo '<div class="ck-college-error">';
    echo '<p>College not found. Please <a href="' . home_url('/colleges/') . '">browse our colleges</a>.</p>';
    echo '</div>';
    return;
}
        ...
        <div class="college-header-section">
            <div class="college-header-content">
                <div class="college-title-area">
                    ...
                    <h1 class="college-title"><?php echo esc_html($college->post_title); ?></h1>
        ...
        <div class="college-content-area">
            <div class="college-main">
                ...
                <div class="content-section">
                    <h2>About <?php echo esc_html($college->post_title); ?></h2>
                    <div class="section-content">
                        <?php
                        $content = $college->post_content;
                        if ($content) {
